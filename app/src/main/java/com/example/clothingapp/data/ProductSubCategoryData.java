...
public class ProductSubCategoryData {
    static final private List<ProductSubCategory> productSubCategoriesList =
            Arrays.asList(
                    new ProductSubCategory("sub-category-1", "Dresses", "@drawable/dresses", "category-1"),
                    new ProductSubCategory("sub-category-2", "Dresses", "@drawable/dresses", "category-1"),
                    new ProductSubCategory("sub-category-3", "Dresses", "@drawable/dresses", "category-1"),
                    new ProductSubCategory("sub-category-4", "Dresses", "@drawable/dresses", "category-1"),
